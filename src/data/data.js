...
import curriculumReact from '../img/projects/curriculum-react.gif';
import cardHoverEffect from '../img/projects/cards-hover-effects.gif';
import cardProduct from '../img/projects/product-card.gif';
...
export const user = {
  ...
  projects: [
    ...
    {
      id: 4,
      image: curriculumReact,
      link: 'https://github.com/jeremiaslorenzettibrizolla/curriculum-react.git',
      title: 'Currículo em react',
      text: 'Aplicação react com integração com uma api node para salvar os dados dos contatos em um banco de dados com postgres',
    },
    {
      id: 5,
      image: cardHoverEffect,
      link: 'https://github.com/jeremiaslorenzettibrizolla/frontends/tree/master/cards-hover-effects',
      title: 'Cards com efeitos de hover',
      text: 'Cards construido apenas com HTML e CSS',
    },
    {
      id: 6,
      image: cardProduct,
      link: 'https://github.com/jeremiaslorenzettibrizolla/frontends/tree/master/product-card',
      title: 'Card de produto',
      text: 'Card construido apenas com HTML e CSS',
    },
  ],
};
